...
func init() {
	...
	refineCmd.Flags().StringVar(&refineHarness, "harness", "", "Agent CLI to use for prompt regeneration (claude|antigravity|agy|gemini, or any claude-compatible wrapper)")
